...
powershell -ExecutionPolicy Bypass -File scripts\New-PortableRelease.ps1 -Version 0.5.0 -Platform x64
powershell -ExecutionPolicy Bypass -File scripts\New-InstallerRelease.ps1 -Version 0.5.0 -Platform x64
```
