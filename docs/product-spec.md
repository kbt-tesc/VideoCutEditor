...
- Show encoder information, media information, and export logs in an INFO surface with its own scrolling area so logs do not expand the main editor layout.
