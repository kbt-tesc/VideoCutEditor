...
public sealed partial class ExportListWindow : Window
{
    ...
    public ExportListWindow(MainPageViewModel viewModel, nint ownerWindowHandle)
    {
        ViewModel = viewModel;
        InitializeComponent();
    ...
    private void RemoveClipButton_Click(object sender, RoutedEventArgs e)
    {
    ...
    private void ResizeToDefault()
    {
        ...
        AppWindow.Resize(new SizeInt32((int)(720 * scale), (int)(480 * scale)));
    }
}
